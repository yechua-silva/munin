...
echo "[1/4] Git push local → GitHub..."
...
echo "[2/4] SSH al droplet + git pull en container..."
...
# ── Paso 3: pip install ─────────────────────────────────────────────────────
echo "[3/4] pip install dependencies en container..."
...
# ── Paso 4: Verificar best.pt + run tests ────────────────────────────────────
echo "[4/4] Verificando best.pt + running tests..."
